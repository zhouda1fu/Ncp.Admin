    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, comment: "订单推送标识"),
                    OrderId = table.Column<Guid>(type: "uuid", nullable: false, comment: "订单ID"),
                    Type = table.Column<int>(type: "integer", nullable: false, comment: "推送类型"),
                    PusherId = table.Column<long>(type: "bigint", nullable: false, comment: "推送人用户ID"),
                    PusherName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, comment: "推送人姓名"),
                    PushTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, comment: "推送时间"),
                    Process = table.Column<int>(type: "integer", nullable: false, comment: "推送进程状态码"),
                    ProcessName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "推送进程状态描述"),
                    Reason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "推送原因或失败信息")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_push", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<Guid>(type: "uuid", nullable: false, comment: "产品分类ID"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentId = table.Column<Guid>(type: "uuid", nullable: true, comment: "上级分类ID（00000000-0000-0000-0000-000000000000 或 null 为根）"),
                    SortOrder = table.Column<int>(type: "integer", nullable: false, comment: "排序"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecorderId = table.Column<long>(type: "bigint", nullable: false, comment: "记录人用户ID（无则为 0）"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: false),
                    SharedToUserId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_push_OrderId",
                table: "order_push",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_order_push_Process",
                table: "order_push",
                column: "Process");

            migrationBuilder.CreateIndex(
                name: "IX_order_push_PusherId",
                table: "order_push",
                column: "PusherId");

            migrationBuilder.CreateIndex(
                name: "IX_order_push_PushTime",
                table: "order_push",
                column: "PushTime");

            migrationBuilder.CreateIndex(
                name: "IX_order_push_Type",
                table: "order_push",
                column: "Type");
