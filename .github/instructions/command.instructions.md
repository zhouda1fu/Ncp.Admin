---
applyTo: "src/Ncp.Admin.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Admin.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/Ncp.Admin.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using Ncp.Admin.Domain.AggregatesModel.UserAggregate;
using Ncp.Admin.Infrastructure.Repositories;

namespace Ncp.Admin.Web.Application.Commands.Users;
