---
applyTo: "src/Ncp.Admin.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Admin.Web/Application/DomainEventHandlers/` 目录下。
...
using Ncp.Admin.Web.Domain.DomainEvents;
