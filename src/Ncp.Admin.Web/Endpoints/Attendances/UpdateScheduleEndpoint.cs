...
/// 更新排班（班次时间与名称）
/// </summary>
public class UpdateScheduleEndpoint(IMediator mediator) : Endpoint<UpdateScheduleRequest, ResponseData<bool>>
{
    public override void Configure()
    {
        Tags("Attendance");
        Description(b => b.AutoTagOverride("Attendance").WithSummary("更新排班（班次时间与名称）"));
