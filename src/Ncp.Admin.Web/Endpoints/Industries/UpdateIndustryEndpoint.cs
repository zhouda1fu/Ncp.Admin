...
using Ncp.Admin.Web.Application.Commands.Industries;
using Ncp.Admin.Web.AppPermissions;

namespace Ncp.Admin.Web.Endpoints.Industries;
    ...
    : Endpoint<UpdateIndustryRequest, ResponseData<bool>>
{
    ...
    {
        Tags("Industry");
        Description(b => b.AutoTagOverride("Industry").WithSummary("更新行业"));
