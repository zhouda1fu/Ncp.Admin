...
/** @type {import("D:/github/Ncp.Admin/frontend/packages/@core/base/shared/src/color/index.js")} */
const _module = await jiti.import("D:/github/Ncp.Admin/frontend/packages/@core/base/shared/src/color/index.ts");
