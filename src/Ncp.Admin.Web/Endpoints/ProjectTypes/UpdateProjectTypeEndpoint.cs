...
using Ncp.Admin.Web.Application.Commands.ProjectTypes;
using Ncp.Admin.Web.AppPermissions;

namespace Ncp.Admin.Web.Endpoints.ProjectsTypes;
...
public class UpdateProjectTypeEndpoint(IMediator mediator) : Endpoint<UpdateProjectTypeRequest, ResponseData<bool>>
{
    ...
    {
        Tags("ProjectType");
        Description(b => b.AutoTagOverride("ProjectType").WithSummary("更新项目类型"));
