...
/** @type {import("D:/github/Ncp.Admin/src/frontend/packages/@core/base/shared/src/utils/index.js")} */
const _module = await jiti.import("D:/github/Ncp.Admin/src/frontend/packages/@core/base/shared/src/utils/index.ts");
