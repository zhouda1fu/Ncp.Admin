---
applyTo: "src/Ncp.Admin.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Admin.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/Ncp.Admin.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using Ncp.Admin.Domain.Aggregates.UserAggregate;
