...
public class CreateProductCommandValidator : AbstractValidator<CreateProductCommand>
{
    public CreateProductCommandValidator()
    {
        ...
        RuleFor(c => c.ActivationCode).NotNull().MaximumLength(200);
        RuleFor(c => c.PriceStandard).NotNull().MaximumLength(200);
        RuleFor(c => c.MarketSales).NotNull().MaximumLength(500);
        ...
        RuleFor(c => c.OperationProcessResources).NotNull().MaximumLength(2000);
        RuleFor(c => c.Introduction).NotNull().MaximumLength(4000);
        RuleFor(c => c.IntroductionResources).NotNull().MaximumLength(2000);
