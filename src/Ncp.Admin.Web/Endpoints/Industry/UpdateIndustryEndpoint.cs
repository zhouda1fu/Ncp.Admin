...
public record UpdateIndustryRequest(string Name, int SortOrder = 0, string? Remark = null);
    ...
    : Endpoint<UpdateIndustryRequest, ResponseData<bool>>
{
    ...
    public override async Task HandleAsync(UpdateIndustryRequest req, CancellationToken ct)
    {
        ...
        var cmd = new UpdateIndustryCommand(id, req.Name, req.SortOrder, req.Remark);
