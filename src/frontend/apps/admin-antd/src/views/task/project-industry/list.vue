...
} from '#/api/system/project-industry';
...
const [Grid, gridApi] = useVbenVxeGrid<ProjectIndustryApi.ProjectIndustryItem>({
  formOptions: {
...
function onActionClick(
  e: OnActionClickParams<ProjectIndustryApi.ProjectIndustryItem>,
) {
  if (e.code === 'edit') {
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        await deleteProjectIndustry(e.row.id);
