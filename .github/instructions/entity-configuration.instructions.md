---
applyTo: "src/Ncp.Admin.Infrastructure/EntityConfigurations/*.cs"
---
...
- 类文件应放置在 `src/Ncp.Admin.Infrastructure/EntityConfigurations/` 目录下。
- 文件名格式为 `{EntityName}EntityTypeConfiguration.cs`。

## 代码示例

**文件**: `src/Ncp.Admin.Infrastructure/EntityConfigurations/UserEntityTypeConfiguration.cs`
