---
applyTo: "src/Ncp.Admin.Web/Application/IntegrationEventConverters/*.cs"
---
...
- 转换器应放置在 `src/Ncp.Admin.Web/Application/IntegrationEventConverters/` 目录下。
- 转换器文件名格式为 `{Entity}{Action}IntegrationEventConverter.cs`。

## 代码示例

**文件**: `src/Ncp.Admin.Web/Application/IntegrationEventConverters/UserCreatedIntegrationEventConverter.cs`

```csharp
using Ncp.Admin.Domain.DomainEvents;
using Ncp.Admin.Web.Application.IntegrationEvents;

namespace Ncp.Admin.Web.Application.IntegrationEventConverters;
